    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative flex min-h-screen items-center px-4 py-20 md:px-20">
        <div className="mx-auto max-w-[1400px] px-4">
          <div className="mx-auto grid w-full max-w-[1400px] grid-cols-1 md:grid-cols-2 items-center gap-8">
            ...
            >
              ...
              <div className="mt-12 space-y-8">
                ...
                >
                  Building powerful digital solutions from front to back. Together we&apos;ll create seamless
                  experiences. Always embracing innovation and modern technologies. As a full stack developer, my
                  expertise in both frontend and backend development allows me to craft complete, scalable applications
            ...
            >
              <div className="relative">
                <motion.div
                  ...
                  className="relative w-[420px] h-[520px] bg-gradient-to-br from-neutral-50 to-white rounded-3xl shadow-xl border border-neutral-200/80 overflow-hidden"
                >
                  {/* Main image container */}
                  <div className="relative w-full h-full p-4">
                    <div className="w-full h-full bg-gradient-to-br from-neutral-100/50 to-neutral-50 rounded-2xl overflow-hidden shadow-lg">
                      <img
                        src="/my1.png"
                  ...
                  <div className="absolute top-6 right-6 w-3 h-3 bg-sky-500/30 rounded-full"></div>
                  <div className="absolute bottom-6 left-6 w-2 h-2 bg-neutral-400/40 rounded-full"></div>

                  {/* Clean border accent */}
                  <div className="absolute inset-0 rounded-3xl ring-1 ring-inset ring-neutral-300/20"></div>
                </motion.div>
              </div>
            </motion.div>
          </div>
              ...
              <div className="grid md:grid-cols-2 gap-20">
                ...
                <div className="space-y-8">
                  <div className="space-y-4">
                    ...
                    <h3 className="text-5xl font-bold text-neutral-800">Creating Exceptional User Experiences</h3>
                  ...
                  <p className="text-xl text-neutral-600 leading-relaxed">
                    Specializing in modern web development with a focus on performance, interactivity, and responsive
                    design.
                  </p>
                  ...
                  >
                    {[
                      ...
                      <div key={skill} className="flex items-center gap-2 group">
                        ...
                        <span className="text-neutral-600 group-hover:text-neutral-800 transition-colors">{skill}</span>
                      </div>
                    ))}
                  </motion.div>
                </div>
                    ...
                    {[
                      {
                        ...
                        description:
                          "Building with the latest frameworks and tools to ensure optimal performance and maintainability.",
                      },
                      {
              ...
              <div className="grid md:grid-cols-2 gap-20">
                ...
                <div className="space-y-8">
                  <div className="space-y-4">
                    ...
                    <h3 className="text-5xl font-bold text-neutral-800">Building Robust Systems</h3>
                  </div>

                  <p className="text-xl text-neutral-600 leading-relaxed">
                    Developing scalable server-side solutions with a focus on performance, security, and reliability.
                  </p>
              ...
              <div className="grid md:grid-cols-2 gap-20">
                ...
                <div className="space-y-8">
                  <div className="space-y-4">
                    ...
                    <h3 className="text-5xl font-bold text-neutral-800">End-to-End Development</h3>
                  </div>

                  <p className="text-xl text-neutral-600 leading-relaxed">
                    Delivering complete web solutions from concept to deployment with seamless integration between
                    ...
                    {[
                      {
                        ...
                        description:
                          "Building full-stack applications with seamless integration and optimal performance.",
                      },
                      {
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} className="relative group">
              <div className="flex flex-col md:flex-row gap-8 md:gap-16">
                ...
                <div className="md:w-3/4 relative">
                  ...
                  <div className="space-y-8">
                    <p className="text-xl text-neutral-600 leading-relaxed">
                      Led the development of multiple high-impact web applications using Next.js and React. Implemented
                      complex animations and interactive features that enhanced user engagement. Mentored junior
                      developers and established best practices for the frontend team.
                    </p>
                    <div className="pt-6">
                      <div className="text-sm text-neutral-400 mb-3">Technologies Used</div>
                      <div className="flex flex-wrap gap-2">
                        {["Next.js", "React", "TypeScript", "Framer Motion", "TailwindCSS", "Node.js"].map(
                          (tech, index) => (
                            <motion.span
                              key={tech}
